...
const image = new CAL.Image('img/hourglass.png', 0, 0, 1, 1, {
	x: 450,
	y: 50,
	alpha: 0.5
}).load(() => {
...
const collisionMapShape = new CAL.CollisionMap().createFromShape(shape, {margin: 10, applyMatrix: true});
